# Django settings for myOpenCompany project.
...
SECRET_KEY = '$6y4pnmnh&55el1i9ddxgo7y6-gzah4cq$yffp#!5xnyyba$as'
...
ROOT_URLCONF = 'myOpenCompany.urls'
...
INSTALLED_APPS = (
    ...
    # Use south to handle schema migration
    'south',
