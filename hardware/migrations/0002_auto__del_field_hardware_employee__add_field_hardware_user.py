...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Hardware.employee'
        db.delete_column('hardware_hardware', 'employee_id')

        # Adding field 'Hardware.user'
        db.add_column('hardware_hardware', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Hardware.employee'
        db.add_column('hardware_hardware', 'employee', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['employees.Employee']), keep_default=False)

        # Deleting field 'Hardware.user'
        db.delete_column('hardware_hardware', 'user_id')
