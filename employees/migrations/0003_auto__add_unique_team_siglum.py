...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Team', fields ['siglum']
        db.create_unique('employees_team', ['siglum'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Team', fields ['siglum']
        db.delete_unique('employees_team', ['siglum'])
