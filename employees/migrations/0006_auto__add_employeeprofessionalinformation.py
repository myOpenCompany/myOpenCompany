...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EmployeeProfessionalInformation'
        db.create_table('employees_employeeprofessionalinformation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employees.Team'])),
            ('entry_date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('employees', ['EmployeeProfessionalInformation'])


    def backwards(self, orm):
        
        # Deleting model 'EmployeeProfessionalInformation'
        db.delete_table('employees_employeeprofessionalinformation')
    ...
    models = {
        ...
        'employees.employeeprofessionalinformation': {
            'Meta': {'object_name': 'EmployeeProfessionalInformation'},
            'entry_date': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'team': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['employees.Team']"}),
