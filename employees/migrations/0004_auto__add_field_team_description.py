...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('employees_team', 'description', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Team.description'
        db.delete_column('employees_team', 'description')
