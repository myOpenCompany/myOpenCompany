...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Employee.entry_date'
        db.add_column('employees_employee', 'entry_date', self.gf('django.db.models.fields.DateField')(default="2001-10-01"), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Employee.entry_date'
        db.delete_column('employees_employee', 'entry_date')
