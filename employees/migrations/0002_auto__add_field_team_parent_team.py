...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.parent_team'
        db.add_column('employees_team', 'parent_team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employees.Team'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Team.parent_team'
        db.delete_column('employees_team', 'parent_team_id')
